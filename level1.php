...
<head>
    ...
    <style>
        body {
            ...
            padding: 0;
            overflow: hidden;
            background-image: url(img/maingamebg.gif);
...
<body>
    ...
    <canvas></canvas>
    <img src="./img/platform.png" class="Platform" id="Platform">
    <img src="./img/capyidle.png" class="PLayer" id="Player">
    <img src="./img/capyidle_jump.png" class="PLayer" id="Player">
    <img src="./img/capyidle_walk.gif" class="PLayer" id="Player">
