...
const playerJumpSprite = new Image(); playerJumpSprite.src = 'img/capyidle.png';

const playerIdleSprite = new Image(); playerIdleSprite.src = 'img/capyidle_jump.png';
...
window.addEventListener('DOMContentLoaded', function() {
    ...
    function play() {
        var music = new Audio('img/level1.mp3');
        music.play();
    }
...
function updateScrollOffsetDisplay() {
    ...
    scrollOffsetDisplay.textContent = scrollOffset + ' Points (3000 to win)';
}